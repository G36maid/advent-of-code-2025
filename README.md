...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `44.5µs` | `46.2µs` |
| [Day 2](./src/bin/02.rs) | `2.5µs` | `311.8µs` |
| [Day 3](./src/bin/03.rs) | `70.5µs` | `78.1µs` |
| [Day 4](./src/bin/04.rs) | `302.5µs` | `964.7µs` |
| [Day 5](./src/bin/05.rs) | `107.7µs` | `36.9µs` |
